...
export default function MyStats({ cards, categories, categoryRecords, subcategories: _subcategories, categoryStats, reviewLog, srSettings, onShowPlanner: _onShowPlanner, onShowOnboarding }: Props) {
